...
public class A_Array {
	 ...
	 * 		ex) int[] a= new int[3];
	 * 		int 자료형 값을 담을 수 있는 저장공간이 3번 할당된다.
	 * 		[0, 0, 0]
	 * 		배열에서 저장된 데이터를 꺼낼 때는 "인덱스"를 활용하며, 인덱사 값은 0부터 시작.
	 * 		arr[0],arr[1],arr[2]
	...
	public void method5() {
		 ...
		 * 
		 * 2.초기화 완료된 배열을 반복문을 활용하여 내부에 저장된 값으 ㄹ출력
		 * 출력 형식 : 10 8 6 4 2
		 */
		int [] arr = new int[5];
		int num = 0;
	...
	public void method7() {
		...
		//1. toCharArray()함수 사용
		char[] arr = str.toCharArray(); // ['m','e','e','r','y']
