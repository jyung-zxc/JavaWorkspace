...
public class A_UncheckedException {
	...
	/*
	 * UncheckedException
	 *  - RuntimeException처럼 프로그램 실행시 발생되는 예외들이 
	 *    대표적인 UncheckedException계열의 예외들이다.
	 *    
	 *  - RuntimeException의 자식 클래스들 
	 *    1. ArrayIndexOutOfBoundsException
	 *    2. NegativeArraaySizeException
	 ...
	 *     예외 처리가 애초에 발생이 안되게끔, 대부분 조건문으로 해결이 가능핟.
	 *     즉, 굳이 예외처리(예외처리코드들)을 할 필요가 없다는 의미.
	 */
...
//			}
	 ...
	 *  - 조건문으로 해결이 가능하기 때문에 예외 자체가 
	 *    애초에 발생 안되게끔 개발자가 소스코드로 핸들링하는게 권장된다.
	 *    
