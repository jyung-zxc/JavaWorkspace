...
public class B_StringBuilderAndBuffer {
	 ...
	 *  - 두 클래스의 사용방법은 동일함
	 *  - 차이점은 "동기화"여부
	 *  - StringBuilder은 동기화를 지원하지 않기 떄문에 "멀티스레드환경"에서 좋은 성능을 보인다.
	 *  - StringBuffer은 동기화를 지원하기 때문에 "멀티스레드환경"에서 스레드 안정성을 보장할 수 있으나
	 *    성능이 좋지 못하다.
	 */
