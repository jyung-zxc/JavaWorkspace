...
//		 방법1. replace
		...
		StringTokenizer atn = new StringTokenizer(str, " ");
		String result2 = "";
		while (atn.hasMoreTokens()) {
			result2 += atn.nextToken();
		}
	...
	public String firstCap(String input) {
		//String str1 = input.replace(input.charAt(0), input.toUpperCase().charAt(0));
		// 매개변수로 받아온 input의 첫 번째 글자만 대문자로 바꾼 문자열 반환
		// 방법1. substring으로 문자를 하나 뺴고, 대문자로 변경후 합쳐서 반환
