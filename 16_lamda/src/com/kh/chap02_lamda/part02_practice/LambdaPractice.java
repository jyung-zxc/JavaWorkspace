...
import com.kh.chap02_lamda.model.functional.LambdaTest02;
...
//		4. 중괄호 생략 가능
		// - 단, 실행할 코드가 한문장인 경우
		LambdaTest02 lambda4 = str -> System.out.println(str);
...
//			답 : arr -> Math.max(Math.max(arr[0], arr[1]), arr[2]);
		...
		// 10. ((String str1, String str2) 
//		-> { String result = (str1.conact(str2));  return result; });
//			답 :(str1,str2) -> {return result = (str1.conact(str2));
//							  return result;};
	}	
}
