...
public class KakaoUserInfoResponse {
	 ...
	 *    각 서비스마다 요구하는 데이터의 형식 및 반환되는 응답의 형식
	 *    이 다양하기 떄문에
	 *    , 이에 맞춰서 DTO 클래스를 설계시 굉장히 많은 양의 클래스들이 나온다.
	 *    
	 *  - 이렇게 너무 많은 DTO클래스가 파일로 존재하면 관리가 힘들어지므로 
	 ...
	 *  - 객체지향적으로 설계된 클래스
	 *  
	 *  - 어플리케이션의 핵심적인 역할을 수행하는 클래스를 정의하는 클래스명,
	 *    데이터의 불변성이 유지되어야 하기때문에 데이터를 중간에 변경할 수 있는 Setter메서드는 정의 하지 않는다.
	 *    캡슐화 및 상속이 구현되어 있으며, equals & hashcode등 객체의 기능을 정의하는 메서드들이 있디ㅏ.
	 */
