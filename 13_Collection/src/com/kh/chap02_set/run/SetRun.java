...
//		hs2.add(new Student("",,));
		...
		Student s1 = new Student("홍길동",30,10);
		Student s2 = new Student("홍길동",30,10);
		...
		System.out.println("\n=======Iterator 반복=======");
		// 2. Iterator를 통한 반복
		// - List계열과 Set계열에서는 Iterator를 직접 구현하였기 떄문에 
		...
		Set<Integer> set2 = new TreeSet<>(comp); // 정수 내림차순 정렬조건 가진 객체
		set2.addAll(set1);
