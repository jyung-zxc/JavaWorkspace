...
public class A_variable {
	...
	public void printVariable() {
		...
		System.out.println("김동욱: " + 8500 * 6 * 5);
		System.out.println("김동욱1: " + 8500 * 6 * 5);
		System.out.println("김동욱2: " + 8500 * 6 * 5);
		System.out.println("김동욱3: " + 8500 * 6 * 5);
		...
		System.out.println("김동욱 : " + pay * time * date);
		System.out.println("김동욱1 : " + pay * time * date);
		System.out.println("김동욱2 : " + pay * time * date);
		System.out.println("김동욱3: " + pay * time * date);
	}
	public void declareVariable(){
		...
		int iNum; // 4byte; -> 정수 대표 자료형 -2,147,483,648 ~ 2,147,483,647 (21억4천)
		long lNum; // 8byte 
